...
@temperature = private unnamed_addr constant [12 x i8] c"temperature\00", align 1
@last_temperature = private unnamed_addr constant [17 x i8] c"last_temperature\00", align 1
...
if_merge13:                                       ; preds = %if_else12, %unreachable_split
  ret void
}
...
entry:
  ...
  call void @klee_make_symbolic(i8* %1, i64 2, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @temperature, i32 0, i32 0))
  %2 = alloca i16, align 2
  %3 = bitcast i16* %2 to i8*
  call void @klee_make_symbolic(i8* %3, i64 2, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @last_temperature, i32 0, i32 0))
  call void @boiler_wrapper(i16* %0, i16* %2)
  ret void
}

define void @boiler_wrapper(i16* %0, i16* %1) {
entry:
  %state = alloca %boiler.state, align 8
  call void @boiler.init(%boiler.state* %state)
  %2 = load i16, i16* %0, align 2
  %temperature = getelementptr %boiler.state, %boiler.state* %state, i32 0, i32 0
  store i16 %2, i16* %temperature, align 2
  %3 = load i16, i16* %1, align 2
  %last_temperature = getelementptr %boiler.state, %boiler.state* %state, i32 0, i32 2
  store i16 %3, i16* %last_temperature, align 2
