...
@i = private unnamed_addr constant [2 x i8] c"i\00", align 1
...
entry:
  ...
  call void @klee_make_symbolic(i8* %1, i64 2, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @i, i32 0, i32 0))
  call void @pcopy_wrapper(i16* %0)
  ret void
}

define void @pcopy_wrapper(i16* %0) {
entry:
  %state = alloca %pcopy.state, align 8
  call void @pcopy.init(%pcopy.state* %state)
  %1 = load i16, i16* %0, align 2
  %i = getelementptr %pcopy.state, %pcopy.state* %state, i32 0, i32 0
