...
entry:
  ...
  %1 = call i1 @nondet_value_for_heater_on()
  store i1 %1, i1* %state.heater_on, align 1
  %state.last_temperature = getelementptr %boiler.state, %boiler.state* %state, i32 0, i32 2
  %2 = call i16 @nondet_value_for_last_temperature()
  store i16 %2, i16* %state.last_temperature, align 2
  ret void
}

declare i16 @nondet_value_for_temperature()

declare i1 @nondet_value_for_heater_on()

declare i16 @nondet_value_for_last_temperature()
